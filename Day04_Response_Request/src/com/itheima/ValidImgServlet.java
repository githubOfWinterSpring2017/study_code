...
public class ValidImgServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//3、设置背景色
		grap.setColor(Color.lightGray);
		grap.fillRect(0, 0, width, height);
		//4、设置边框
		grap.setColor(Color.green);
		grap.drawRect(0, 0, width-2, height-2);
		//5、设置干扰线
		grap.setColor(Color.red);
		for(int i=0;i<5;i++)
			grap.drawLine(randNumber(0,width), randNumber(0,height), randNumber(0,width), randNumber(0,height));
		//6、写字
		...
		grap.setFont(new Font("黑体",Font.BOLD,20));
		for(int i=0;i<4;i++)
		{
			grap.setColor(new Color(randNumber(0,255),randNumber(0,255),randNumber(0,255)));
			grap.rotate(randNumber(-45,45), 5+i*30, 20);
			grap.drawString(base.charAt(randNumber(0, base.length()-1))+"",5+i*30 , 20);
		}
